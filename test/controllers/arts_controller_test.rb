...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference("Art.count") do
      post arts_url, params: { art: { description: @art.description, name: @art.name, type_id: @art.type_id } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { description: @art.description, name: @art.name, type_id: @art.type_id } }
